...
self.addEventListener('install', event => {
  event.waitUntil(
    Promise.all([
      ...
      // Create offline page - use Response instead of Request with body
      caches.open(STATIC_CACHE)
        .then(cache => {
          const offlineHtml = '<!DOCTYPE html><html><head><title>Offline</title><style>body{font-family:sans-serif;text-align:center;padding:20px}h1{color:#333}</style></head><body><h1>You are offline</h1><p>Please check your internet connection and try again.</p></body></html>';
